# TS Join Request Acceptor Bot

**A Advance Join Request Accept Bot Which Can Accept Both All Pending Join Request And New Join Request With Login Feature.**

**For New Join Request Use This Repo [Click Here](https://github.com/TechyShreyansh/Auto-Approval-Bot)**
...
- `DB_URI` : Mongodb Database Url [Tutorial Watch Here](https://youtu.be/UQyc2JmDb84?si=QF01MnX2dir0_kag)
...
## Support Group [VJ Support](https://telegram.me/Tech_Shreyansh2)

## Credit - [Tech VJ](https://youtube.com/@TechShreyansh)
